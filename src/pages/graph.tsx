...
function Graph() {
  ...
  const elements = [
    ...
    { data: { id: "11", type: "customer", label: "Julie Johnston", cdd_risk: 5, country: "MT" } },
    { data: { id: "12", type: "customer", label: "Jennifer Neilson", cdd_risk: 1, country: "NL" } },
    { data: { id: "13", type: "customer", label: "Roger Paletta", cdd_risk: 1, country: "NL" } },
    { data: { id: "14", type: "customer", label: "Jimmy Caron", cdd_risk: 1, country: "MT" } },
    ...
    { data: { id: "18", type: "customer", label: "George Gallo", cdd_risk: 1, country: "NL" } },
    { data: { id: "19", type: "customer", label: "William Smart", cdd_risk: 5, country: "RU" } },
